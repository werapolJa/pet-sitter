...
const PetIcon: React.FC<IconProps> = ({ color = "currentColor" }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
const IconLabelTabs: React.FC = () => {
  ...
  const getTabRoute = (tabValue: number, userid: string) => {
    switch (tabValue) {
      case 0:
        return `/petowners/${userid}`;
      case 1:
        return `/petowners/${userid}/yourpet`;
      case 2:
        return `/petowners/${userid}/booking`;
      default:
        return `/petowners/${userid}`;
    }
  };
  ...
  const handleChange = (event: React.SyntheticEvent, newValue: number) => {
    ...
    if (typeof userid === "string") {
      router.push(getTabRoute(newValue, userid));
    }
  };
