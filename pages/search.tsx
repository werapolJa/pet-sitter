          ...
          <div className="">
            <div className="w-full h-auto md:w-96 md:shadow-md md:rounded-xl">
              <div className="space-y-6 m:pr-1 ">
                ...
                {/* Pet Type */}
                <div className="space-y-2 bg-gray-100 w-full  px-10 py-6 md:px-5 md:bg-white">
                ...
                {/* Rating */}
                <h3 className="font-bold text-base px-10 md:px-5">Rating:</h3>
                <div className="flex flex-wrap gap-3 px-10 md:px-5">
                ...
                {/* Experience */}
                <div className="space-y-2 px-10 pt-3 md:px-5">
                ...
                <div className="hidden md:flex gap-2 px-10 py-6 md:px-5">
